...
# ====================== НАСТРОЙКИ ======================
INPUT_FILE = "power_data_correlated_with_anomalies_s5_noise.xlsx"      # ← поменяй на свой файл
OUTPUT_FILE = "power_data_Agglomerative_8features_predictions.xlsx"
MODEL_PATH = "models/agglomerative_8features_model.pkl"

ANOMALY_START_DAY = 61
START_DATETIME = datetime(2025, 10, 5, 0, 2)

print("=== Agglomerative Clustering (8 features) — Inference ===\n")
...
print("Модель Agglomerative Clustering (8 features) загружена успешно")
...
df['Is_Agglo_Anomaly'] = (df['Agglo_min_dist'] > distance_threshold).astype(int)
df['anomaly_score'] = df['Agglo_min_dist']   # расстояние как score
