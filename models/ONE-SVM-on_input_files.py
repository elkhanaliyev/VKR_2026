...
# ====================== НАСТРОЙКИ ======================
INPUT_FILE = "power_data_correlated_with_anomalies_s3.xlsx"      # ← поменяйте на ваш файл
OUTPUT_FILE = "power_data_OCSVM_4features_predictions.xlsx"
MODEL_PATH = "models/ocsvm_4features_model.pkl"

ANOMALY_START_DAY = 61
START_DATETIME = datetime(2025, 10, 5, 0, 2)

print("=== One-Class SVM (4 features) — Inference Script ===\n")
...
print("One-Class SVM (4 features) успешно загружена")
print(f"Параметры: nu={model_info.get('NU')}, kernel={model_info.get('KERNEL')}, gamma={model_info.get('GAMMA')}\n")
...
df['anomaly_score'] = -df['OCSVM_decision']   # чем меньше — тем более аномально
